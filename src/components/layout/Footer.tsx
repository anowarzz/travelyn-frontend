  ...
  return (
    <footer className="relative text-foreground bg-[#f8fafc] dark:bg-[#0f172a]">
      ...
      <div
        ...
        aria-hidden="true"
      ></div>
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-3 relative z-10 px-4 py-10 lg:px-8 lg:py-16">
        <div className="">
          ...
          <p className="mt-4 max-w-xs text-muted-foreground">
            ...
            <span className="font-bold text-[var(--myGreen)]">Travelyn</span>
            .<br />
            We offer curated tours, expert guides, and seamless booking for your
            next adventure.
          </p>
        ...
        <div className="grid grid-cols-1 px-4 content-center sm:grid-cols-2 gap-8  lg:col-span-2  lg:grid-cols-4">
          <div>
          ...
          <div>
            <p className="font-bold text-base text-foreground mb-2 ">Company</p>
            <ul className="space-y-3 text-sm">
              <li>
                <Link
                  to="/"
      ...
      <div className="border-t border-white/20 text-center relative z-10 px-4 py-4">
        <p className="text-xs mt-2 text-foreground font-medium">
          &copy; {new Date().getFullYear()}{" "}
          <span className="font-bold">Travelyn</span>. All rights reserved.
        </p>
      </div>
    </footer>
  );
